 ...
 */
var q=Object.assign;function r(a){var b=a.keyCode;"charCode"in a?(a=a.charCode,0===a&&13===b&&(a=13)):a=b;10===a&&(a=13);return 32<=a||13===a?a:0}function t(){return !0}function u(){return !1}
...
var ma=q({},D,{deltaX:function(a){return "deltaX"in a?a.deltaX:"wheelDeltaX"in a?-a.wheelDeltaX:0},deltaY:function(a){return "deltaY"in a?a.deltaY:"wheelDeltaY"in a?-a.wheelDeltaY:"wheelDelta"in a?-a.wheelDelta:0},deltaZ:0,deltaMode:0});v(ma);var M=m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;M[0];M[1];M[2];M[3];M[4];aa$1.unstable_act;"blur cancel click close contextMenu copy cut auxClick doubleClick dragEnd dragStart drop focus input invalid keyDown keyPress keyUp mouseDown mouseUp paste pause play pointerCancel pointerDown pointerUp rateChange reset resize seeked submit touchCancel touchEnd touchStart volumeChange drag dragEnter dragExit dragLeave dragOver mouseMove mouseOut mouseOver pointerMove pointerOut pointerOver scroll toggle touchMove wheel abort animationEnd animationIteration animationStart canPlay canPlayThrough durationChange emptied encrypted ended error gotPointerCapture load loadedData loadedMetadata loadStart lostPointerCapture playing progress seeking stalled suspend timeUpdate transitionEnd waiting mouseEnter mouseLeave pointerEnter pointerLeave change select beforeInput compositionEnd compositionStart compositionUpdate".split(" ").forEach(function(a){});
...
var act = testUtils.act;
var findAllInRenderedTree = testUtils.findAllInRenderedTree;
var findRenderedComponentWithType = testUtils.findRenderedComponentWithType;
var findRenderedDOMComponentWithClass = testUtils.findRenderedDOMComponentWithClass;
var findRenderedDOMComponentWithTag = testUtils.findRenderedDOMComponentWithTag;
var isCompositeComponent = testUtils.isCompositeComponent;
var isCompositeComponentWithType = testUtils.isCompositeComponentWithType;
var isDOMComponent = testUtils.isDOMComponent;
var isDOMComponentElement = testUtils.isDOMComponentElement;
var isElement = testUtils.isElement;
var isElementOfType = testUtils.isElementOfType;
var mockComponent = testUtils.mockComponent;
var nativeTouchData = testUtils.nativeTouchData;
